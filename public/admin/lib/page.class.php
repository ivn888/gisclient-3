<?php
    ...
    require_once ADMIN_PATH."lib/tabella_h.class.php";
    require_once ADMIN_PATH."lib/tabella_v.class.php";
    require_once ADMIN_PATH."lib/savedata.class.php";
    require_once ADMIN_PATH."lib/export.php";
