...
class OracleQuery
{
    ...
    function _setQueryGeom($buffer=false)
    {
        ...
        case QUERY_POINT :
            ...
            $sPoly = $this->dbAdpater->img2Circle(
                $imgX, $imgY, $imgR,
                $_REQUEST["geoPix"], $_REQUEST["oXgeo"], $_REQUEST["oYgeo"], $_SESSION[$myMap]["SRID"]
            );//raggio in relazione alle coordinate immagine
            break;
        ...
        case QUERY_POLYGON :
            $sPoly = $this->dbAdpater->img2Polygon(
                $imgX, $imgY,
                $_REQUEST["geoPix"], $_REQUEST["oXgeo"], $_REQUEST["oYgeo"], $_SESSION[$myMap]["SRID"]
            );
            break;
